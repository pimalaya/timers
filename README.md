# I/O Timer [![Documentation](https://img.shields.io/docsrs/io-timer)](https://docs.rs/io-timer/latest/io_timer) [![Matrix](https://img.shields.io/matrix/pimalaya:matrix.org?color=success&label=chat)](https://matrix.to/#/#pimalaya:matrix.org)
